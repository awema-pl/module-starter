 ...
 * MP4
 */
gulp.task('build:mp4', function() {
    return gulp.src('./resources/mp4/**/*')
...
gulp.task('build', gulp.series('build:js', 'build:img', 'build:fonts','build:mp4', 'build:icons', 'build:styles') )
